...
function setup() {
    ...
    stroke(255);
    fill(51);                                                                               // not using noFill() <-- it could create bugs on overlap
}

function draw() {
    background(51);                                                                         // setting background to the same color as box fillinf to create wireframe illusion // reset background every loop for redraw
